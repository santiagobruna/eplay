...
const Categories = () => {
  ...
  const { data: sportsGames, isLoading: isLoadingSportsGames } = useGetSportGamesQuery()
  const { data: fightGames, isLoading: isLoadingFightGames } = useGetFightGamesQuery()
  const { data: simulationGames, isLoading: isLoadingSimulationGames} = useGetSimulationGamesQuery()
